...
#define GIMBAL_GYRO_X_ZERO_CORRECT       0.005f                        //俯仰陀螺仪x轴方向死区修正(云台)
#define GIMBAL_GYRO_Y_ZERO_CORRECT       0.005f                        //俯仰陀螺仪y轴方向死区修正(云台)
#define GIMBAL_GYRO_Z_ZERO_CORRECT       0.005f                        //俯仰陀螺仪z轴方向死区修正(云台)
